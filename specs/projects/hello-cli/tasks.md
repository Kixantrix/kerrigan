...
- [ ] Task: Create setup.py with package metadata
...
- [ ] Task: Install package locally and test
...
- [ ] Task: Validate CI passes
  - Done when: CI workflow runs successfully
  - Links: spec.md (Success metrics)

- [ ] Task: Manual testing of all acceptance criteria
