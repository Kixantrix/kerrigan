...
Follow [session operations](../../playbooks/session-operations.md) for accountable owners, acknowledged lead transfer, routine child decisions, resources, and triage. Worktree isolation is not device isolation.
